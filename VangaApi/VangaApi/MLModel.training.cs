...
namespace VangaApi
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Andrey\Desktop\hakaton\Digital_Challenge_e-e-e-ko-ko-dzhambo_10_37_33\VangaApi\VangaApi\data.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:225,seriesLength:324,trainSize:173485,horizon:100000,outputColumnName:@"col2",inputColumnName:@"col2",confidenceLowerBoundColumn:@"col2_LB",confidenceUpperBoundColumn:@"col2_UB");
